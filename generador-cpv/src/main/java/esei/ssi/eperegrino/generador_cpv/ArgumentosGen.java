...
final class ArgumentosGen {
     ...
     *
     * @param ficheroPaquete El fichero que contiene la CPV a desempaquetar.
     * @param ficheroClavePrivadaOficina El fichero que contiene la clave
     * privada de la oficina del peregrino.
     * @param ficheroClavePublicaPeregrino El fichero que contiene la clave
     * pública del peregrino propietario de la CPV.
     * @param albergues Una lista de identificadores de albergues por los que se
     * piensa que fue sellada la CPV, asociados con su clave pública.
    ...
    /**
     * Obtiene el fichero que contiene la clave privada de la oficina del
     * peregrino.
     *
     * @return El descrito fichero.
     */
    ...
    /**
     * Obtiene el fichero que contiene la clave pública del peregrino
     * propietario de la CPV.
     *
     * @return El descrito fichero.
     */
