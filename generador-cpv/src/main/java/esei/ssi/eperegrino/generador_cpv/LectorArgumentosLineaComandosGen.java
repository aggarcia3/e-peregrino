...
final class LectorArgumentosLineaComandosGen {
    /**
     * Interpreta los argumentos de línea de comandos especificados, deteniendo
     * la ejecución de la aplicación si alguno es inválido, o encapsulando
     * dichos argumentos en un objeto si todo va bien para un procesamiento más
     * fácil.
     *
     * @param args Los argumentos de línea de comandos a interpretar, tal cual
     * son pasados al método estático main.
    ...
    /**
     * Muestra un mensaje por la salida estándar que indica la sintaxis que
     * deben de seguir los argumentos de línea de comandos pasados a esta
     * aplicación, y finaliza su proceso con el código de salida de error 1.
     */
    private static void mostrarSintaxisYSalir() {
        System.out.println("Sintaxis: DesempaquetarCredencial (fichero paquete) (fichero clave privada peregrino) (fichero clave pública oficina)");
        System.exit(1);
    }

    /**
     * Si el fichero pasado como parámetro no es plausible (legible en el
     * momento presente), finaliza el proceso de la aplicación con código de
     * salida de error 2, mostrando antes un mensaje por el flujo de salida de
     * error con más información acerca del fichero que se ha comprobado.
     *
     * @param fichero El fichero a comprobar si es plausible.
     * @param contenido Una descripción textual del contenido esperado del
     * fichero, que se mostrará al usuario.
     */
